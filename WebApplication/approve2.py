...
if count>0 :
        ...
        str997 = "/cgi-bin/Employees_Project/approve2.py?emp_no=" + str99 + "&emp_no2=" + str(emp_no2)
	...
	print '''<p>'''
        ...
        <div id="services" class="container-fluid">
            <h2>Applicant Information</h2><br>'''

        str1 = str(emp_no2)
        #print str1
        sql = "select * from displayview where emp_no='"+(str1)+"';"
...
<div class="container-fluid bg-grey" align="center">
    <h2>Application Response</h2><br>'''
      ...
      <select class="selectpicker form-control show-tick" name="department">'''
        ...
        sql = "insert into employees (emp_no,birth_date,first_name,last_name,gender,hire_date) values ('"+(emp)+"','"+(bdate)+"','"+(fname)+"','"+(lname)+"','"+(sex)+"','"+(hdate)+"');"
        ...
        if department=='Yes' :
            ...
            try:
              # Execute the SQL command
                  cursor.execute(sql)
                  cursor.execute("insert into dept_emp (emp_no,dept_no,from_date) values ('"+(emp)+"','"+(dept)+"','"+(hdate)+"');")
                  cursor.execute("delete from applicants where emp_no='"+str(emp_no2)+"';")
                  db.commit()
              # Fetch all the rows in a list of lists.
