...
<div class="container-fluid">
  ...
  <form action="/cgi-bin/Employees_Project/signin.py" method="post">
...
print   "<a href='/cgi-bin/Employees_Project/adminlogin.py' class='btn btn-default btn-lg'>Click Here</a>"
